...
class GameState:
    ...
    def game_step(self, time_step=0.1, linear_x=0.8, angular_z=0.3):
        ...
        state = np.append(cv_image,normalized_laser)
        ...
        # np.save('trace_camera/trace_camera_x2/tracex_epoch_{}'.format(self.tra_num), turtlebot_x)
        # np.save('trace_camera/trace_camera_y2/tracey_epoch_{}'.format(self.tra_num), turtlebot_y)
        # self.tra_num += 1
        ...
        angle_reward = -math.pow(1.8,angle_reward)
