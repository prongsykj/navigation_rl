...
def main():
	...
	if (train_indicator==1):
		...
		# actor_critic.actor_model.load_weights("actormodel-180-200.h5")
		# actor_critic.critic_model.load_weights("criticmodel-180-200.h5")
		for i in range(num_trials):
			#print("trial:" + str(i))
			#game_state.game_step(0.3, 0.2, 0.0)
			#game_state.reset()
			...
			for j in range(trial_len):
				...
				np.save('reward_laser_12.13/reward_epoch_{}'.format(i), total_reward)
